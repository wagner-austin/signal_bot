#!/usr/bin/env python
"""
managers/pending_actions.py - Encapsulates in-memory pending actions with thread-safe access.
Maintains global state for interactive flows (registration, deletion, and event creation)
using a reentrant lock to prevent race conditions in a concurrent environment.
"""

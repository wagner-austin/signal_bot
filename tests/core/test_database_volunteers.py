...
def test_sign_up_method_creation_and_update():
    """
    tests/core/test_database_volunteers.py - test_sign_up_method_creation_and_update
    Tests the centralized sign_up method for creating a new volunteer and updating an existing volunteer.
    """
    phone = "+5550000000"
    # Create a new volunteer
    msg1 = sign_up(phone, "Initial Name", ["Skill1"], True, None)
    ...
    msg2 = sign_up(phone, "Updated Name", ["Skill2"], False, "Tester")
